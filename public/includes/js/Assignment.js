...
$('.saveButton').on('click',function(){
	...
	var employees={
		...
		phone: $phone.val()
  		...
  		else if(employees.phone.length==0 || employees.name.length==0 || employees.age.length==0 || employees.gender.length==0 || employees.company.length==0 || employees.email.length==0)
  		{
  			alert("Mandatory to fill all fields");
  		}
